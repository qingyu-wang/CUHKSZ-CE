...
def info():
    ...
    params = {
        ...
        "config": {
            ...
            "course_info": {
                "course_code":    {"header": course_info_field_headers["course_code"],    "width": 5},
                "course_name":    {"header": course_info_field_headers["course_name"],    "width": 5},
                "activity_rules": {"header": course_info_field_headers["activity_rules"], "width": 5},

                # "createtime":     {"header": course_info_field_headers["createtime"],     "width": 5},
                # "modifytime":     {"header": course_info_field_headers["modifytime"],     "width": 5},
                # "modifyuser":     {"header": course_info_field_headers["modifyuser"],     "width": 5},
            },
            "course_record": {
            ...
            "activity_info": {
                ...
                "activity_code":   {"header": activity_info_field_headers["activity_code"],   "width": 5},
            ...
            "activity_record": {
                ...
                "note":          {"header": activity_record_field_headers["note"],          "width": 5},
